<x-app-layout>
    ...
    <div class="content top-page">
        <div class="top-demo-shell">
            <div class="top-list-head">
                ...
                <form method="GET" action="{{ route(request()->routeIs('top.demo') ? 'top.demo' : 'top.index') }}" class="top-list-filter" aria-label="記事絞り込み">
                    ...
                    <div class="top-list-filter-field top-list-filter-field-date">
                        <label for="demo_publish_from">公開期間</label>
                        <div class="top-list-filter-date-range">
                            <input
                                id="demo_publish_from"
                                type="date"
                                name="publish_from"
            ...
            <div class="top-demo-grid" role="list">
                @forelse ($data as $item)
                    <div class="top-demo-card">
                        <a href="{{ route('top.show', $item) }}" class="top-demo-card-link" role="listitem">
                            <div class="top-demo-card-image">
                                @php
                                ...
                                @endif
                                <span class="top-demo-card-status top-list-status {{ $item->top_list_status_class }}">
                                    {{ $item->top_list_status_label }}
                                </span>
                            </div>
                            <div class="top-demo-card-body">
                                <span class="create-at">作成日：{{ $item->created_at?->format('Y.m.d') }}</span>
                                <p class="top-demo-card-title">{{ $item->title }}</p>
                                <div class="top-demo-card-meta">
                                ...
                                <div class="top-demo-card-footer">
                        ...
                        <div class="top-demo-card-delete"
