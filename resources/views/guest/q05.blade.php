<div class="pb-8">
    <fieldset>
        ...
        <textarea id="q05" type="text" name="q05" class="@error('q05') bg-red-100 @enderror w-full h-32 pt-3 border border-gray-300 rounded placeholder-gray-300 leading-none" placeholder="記入してください" required>{{ old('q05') }}</textarea>
    </fieldset>
