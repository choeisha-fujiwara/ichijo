...
<body style="margin: 0; padding: 24px; background: #f8fafc; color: #334155; font-family: 'Noto Sans JP', sans-serif;">
    <div style="max-width: 640px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 10px; padding: 24px;">
        <h1 style="margin: 0 0 16px; font-size: 16px; line-height: 1.4; color: #0f172a;">ご予約ありがとうございます</h1>
        ...
        @if (!empty($reservationDateTime))
            <p style="margin: 0 0 12px; font-size: 14px; line-height: 1.8;"><strong>予約日時:</strong> {{ $reservationDateTime }}</p>
        @endif
        
        <hr style="margin: 20px 0 12px; border: 0; border-top: 1px solid #e2e8f0;">
