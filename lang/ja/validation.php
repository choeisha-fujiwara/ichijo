...
return [
    ...
    'ascii' => ':attributeは半角の英数字や記号のみで入力してください。',
    ...
    'decimal' => ':attributeは、小数点以下:decimal桁の数字を入力してください。',
    'declined' => ':attributeは、拒否する入力をしてください。',
    'declined_if' => ':attributeは、:otherが:valueの時は、拒否する入力をしてください。',
    ...
    'doesnt_end_with' => ':attributeは、:values以外の値で終わるように入力してください。',
    'doesnt_start_with' => ':attributeは、:values以外の値で始まるように入力してください。',
    'email' => '※無効な形式のメールアドレスです。',
    'ends_with' => ':attributeには、:valuesのどれかで終わる値を入力してください。',
    'enum' => '選択された:attributeは正しくありません。',
    'exists' => '選択された:attributeは正しくありません。',
    'extensions' => ':attributeは、:valuesの拡張子を入力してください。',
    ...
    'hex_color' => ':attributeには、有効な16進数の色を入力してください。',
    ...
    'lowercase' => ':attributeは、小文字のみで入力してください。',
    'lt' => [
    ...
    'mac_address' => ':attributeには、有効なMACアドレスを入力してください。',
    'max' => [
    ...
    'missing_with' => ':valuesを入力する場合は、:attributeは存在してはいけません。 ',
    'missing_with_all' => ':valuesを入力する場合は、:attributeは存在してはいけません。 ',
    ...
    'password' => [
        ...
        'uncompromised' => '入力の:attributeは、漏洩している恐れがあります。他の:attributeを入力してください。',
    ],
    ...
    'uppercase' => ':attributeは、大文字のみで入力してください。',
